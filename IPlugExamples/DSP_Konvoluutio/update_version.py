...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Jarkko, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/DSP_Konvoluutio-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DSP_Konvoluutio-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DSP_Konvoluutio-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DSP_Konvoluutio-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DSP_Konvoluutio-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DSP_Konvoluutio-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/DSP_Konvoluutio-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/DSP_Konvoluutio.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DSP_Konvoluutio.iss",inplace=1):
